////main 3 lines for AJAX
//var myRequest = new XMLHttpRequest();
//
//myRequest.open("GET", "https://raw.githubusercontent.com/biatoSalo/Training/master/expensiveLuxuryCars.json", true);
//
        ...
        if (myRequest.readyState == 4 && myRequest.status == 200) {
            ...
            if (manufacturerStored === "") {
                ...
                for (var i = 0; i < info.length; i++) {
                    ...
                    console.log(i);
                    console.log(info[i].manufacturer);
                    
                    if (manufacturerStored == i) {
                        
                        document.getElementById("manufacturerC").innerHTML = info[i].manufacturer;
                        
                        document.getElementById("modelC").innerHTML = info[i].model;
                        
                        document.getElementById("priceC").innerHTML = info[i].price;
                        
                        document.getElementById("fullD").innerHTML = info[i].description
                        ;
                        
                        document.getElementById("fullL").innerHTML = '<a href='+info[i].wiki+' target="_blank">Click here to access Wikipedia for more information.</a>';
                        
                        document.getElementById("imgC").innerHTML = '<img src="'+info[i].img+'" width="auto" height="auto" alt="Car Picture">';
                        
                        document.getElementById("videoC").innerHTML = '<iframe width="auto" height="auto" src="'+info[i].video+'" frameborder="0" allowfullscreen></iframe>';
                        
                        
                        var survey = info[i].quality;
                        ...
                        document.getElementById("overallC").innerHTML = survey[j].rating;    
                        
                        
                        var surveyData = survey[j].rating;
                        
                        
                        
                        console.log(survey[j].rating);
                        console.log(survey[j].model);
                        console.log(survey[j].price);
                        console.log(survey[j].description);
                    }
                    ...
                    console.log(manuf[i].model);
                    console.log(manuf[i].price);
                    console.log(manuf[i].description);
                ...
                /*console.log(survey.overall);*/
                
                /*var carImage = myData.data[manufacturerStored].img;*/
